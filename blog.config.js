...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '精选Mac效率工具与方法', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.macapphq.com', // 网站地址
  ...
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/lizhi_cps_1080_600.png', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
